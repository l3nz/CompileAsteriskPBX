...
DOWNLOAD_URL=http://downloads.asterisk.org/pub/telephony/certified-asterisk
ASTVERSION=asterisk-certified-13.1-cert7
TARGET_DIR=/usr/src/
...
# remove developement packages and dependencies
